Ext.define('tms.controller.SeriesController', {
    extend:'Ext.app.Controller',
    stores:['tms.store.SeriesStore'],
    models:['tms.model.Series'],
    views:['tms.view.series.List'],
    ...
    onDelete:function (me, e, eOpts) {
        ...
        Ext.MessageBox.confirm(
            small_hint
            , Ext.String.format(records_delete_confirm, i18n.t('series') + ":" + record.getRecordName())
            , function (btn) {
                if (btn == "yes") {
